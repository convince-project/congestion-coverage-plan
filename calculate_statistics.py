    ...
    for row_id in range(0, len(data), num_rows):
        ...
        for i in range(0,num_rows ):
            if data[row_id+i][1] == "steps_avg":
                ...
                cpu_time_tsp.append(float(datetime.strptime(data[row_id+i][3], "%H:%M:%S.%f").timestamp()))
            ...
            if data[row_id+i][1] == "steps_lrtdp":
                ...
                cpu_time_lrtdp.append(float(datetime.strptime(data[row_id+i][3], "%H:%M:%S.%f").timestamp()))
